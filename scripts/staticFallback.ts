...
export function staticFallback(base: string) {
  return `<main class="static-fallback">
    ...
    <section><img src="${base}images/portrait.jpg" alt="Kushal overlooking the New York skyline" width="280" height="276" /><h2>Data pipelines. Real impact.</h2><p>Data Engineer at Spotify. NYU Tandon ’26.</p><p>I build data pipelines and recommendation systems. At NYU’s Team Ultraviolet, I led computer vision for RoboMaster robots.</p></section>
